<script>
	import {selectedstore} from './database.js';
...
<div class="w-full fixed inset-x-0 bottom-0 mb-4 mx-auto notselect" style="height:10vh; background-color:transparent; fill:transparent;">
